<template>
  <main>
          ...
          <div class="row gx-4">
            <div class="col-auto">
              <div class="avatar avatar-xl position-relative">
                <img src="../assets/img/avatar-default.png" alt="profile_image" class="shadow-sm w-100 border-radius-lg" />
              </div>
            </div>
    ...
    <div class="py-4 container-fluid">
      <div class="row">
        <div class="col-md-8">
          <my-profile-card  :data=data></my-profile-card>
        </div>
        <div class="col-md-4">
          <q-r-code-card/>
        </div>
...
import QRCodeCard from "@/views/components/QRCodeCard.vue";
import MyProfileCard from "@/views/components/MyProfileCard.vue";
...
export default {
  ...
  methods: {
    async getData() {
      const { data } = await UserRepository.get('my-profile');
      if (data.status == 200) {
        this.data = data.data
      }
    }
